...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> addBooking(Long userId, BookingCreateDto requestDto) {
    ...
    public ResponseEntity<Object> getOwnerItemsBookings(Long ownerId, BookingState state) {
    }
