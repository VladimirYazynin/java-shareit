...
CREATE TABLE IF NOT EXISTS items (
    ...
    CONSTRAINT fk_items_user_id FOREIGN KEY (owner_id) REFERENCES users (id) ON DELETE CASCADE,
    CONSTRAINT fk_items_request_id FOREIGN KEY (request_id) REFERENCES requests (id) ON DELETE SET NULL
);
